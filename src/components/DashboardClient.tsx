      ...
      {!data ? (
        ...
        <div className="rounded-lg border border-dashed border-stone-300 bg-white/70 px-6 py-16 text-center">
          ...
          <p className="mx-auto mt-2 max-w-md text-stone-600">
            Run a full sync to scan your Gmail for application confirmations,
            interview invites, and other hiring status emails. Matching rows are
            written to a Google Sheet automatically.
          </p>
          <button
            type="button"
            disabled={isPending}
