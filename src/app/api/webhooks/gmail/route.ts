 ...
 * Configure the subscription to POST here when mailbox changes.
 * Notification payload does not include message bodies — we sync via history.list.
 */
export async function POST(request: Request) {
  ...
  // Fire-and-forget style within the request — keep under Pub/Sub ack deadline when possible
