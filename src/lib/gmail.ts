...
/** Gmail search that prefers ATS / application confirmations over general mail. */
export const JOB_MAIL_QUERY =
  "(" +
  [
    "subject:(application OR applied OR interview OR assessment OR offer OR hiring OR candidacy OR \"thank you for applying\" OR \"we received your\")",
